...
export const Footer: React.FC = () => {
  const { language, setFilters, setActiveTab, customLogoUrl, isLoggedIn, userRole, currentUser } = useMarket();
          ...
          <div className="col-span-2">
            <div className="flex items-center gap-2 mb-3">
              <img
                ...
                className="h-12 sm:h-14 w-auto max-w-[200px] object-contain shrink-0"
                onError={(e) => {
            ...
            <div className="space-y-2 text-xs text-slate-300">
              <div className="flex items-center gap-2">
                ...
                <span>Level 12, Banani Tower, Banani, Dhaka-1213</span>
              </div>
              <div className="flex items-center gap-2">
                <Phone className="w-4 h-4 text-sky-400 shrink-0" />
                <span>01533830784 (Helpline 24/7)</span>
              </div>
              <div className="flex items-center gap-2">
                ...
                <div className="bg-slate-900 p-2.5 rounded-xl border border-slate-800 text-[11px] text-slate-300 space-y-1">
                  {language === 'bn' ? (
                    <>
                      ...
                      <p><strong className="text-pink-400">লগইন আইডি / পাসওয়ার্ড:</strong> admin (বা official.marketbd@gmail.com) / admin (বা 123456)</p>
                    ...
                    <>
                      ...
                      <p><strong className="text-pink-400">Login / Password:</strong> admin (or official.marketbd@gmail.com) / admin (or 123456)</p>
