...
import { Download, Sparkles, CheckCircle2, ShieldCheck, RefreshCw, Smartphone, AlertOctagon, ExternalLink } from 'lucide-react';
...
export const AppUpdateModal: React.FC = () => {
  ...
  const handleDownloadApk = () => {
    window.open(appRelease.apkDownloadUrl, '_blank');
  };
            ...
            <>
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="py-2.5 px-3 bg-slate-800 hover:bg-slate-700 text-slate-300 font-bold text-xs rounded-xl transition border border-slate-700 cursor-pointer flex items-center gap-1"
