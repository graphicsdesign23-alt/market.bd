...
/* ====================================================================
   Complete Payment Partners Matrix Component (Exact layout from user image)
   ==================================================================== */
  ...
  return (
    <div className={`p-3 sm:p-4 bg-black rounded-2xl border border-slate-800 shadow-2xl space-y-3 ${className}`}>
      <div className="flex items-center justify-between border-b border-slate-800 pb-2">
        ...
        <span className="text-[10px] text-slate-400 font-medium">SSLCOMMERZ Secure Gateway</span>
      </div>

      {/* Row 1: 15 White Card Tiles */}
