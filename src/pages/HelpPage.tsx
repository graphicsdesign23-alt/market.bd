    ...
    <div className="max-w-4xl mx-auto py-8 px-4 space-y-6 text-slate-900 dark:text-slate-100">
      <div className="bg-gradient-to-r from-pink-800 via-rose-700 to-pink-900 text-white p-8 rounded-3xl shadow-xl text-center space-y-2 relative">
        ...
        <h1 className="text-2xl font-black">
          {language === 'bn' ? (
            <><span className="text-amber-300 font-black">মা</span>র্কেট.বিডি (<span className="text-amber-300 font-black">M</span>arketBD.Net) হেল্প সেন্টার ও ব্যবহারের শর্তাবলী</>
          ) : (
            <><span className="text-amber-300 font-black">M</span>arketBD.Net Help Center & Terms of Service</>
          )}
        </h1>
