...
export const DEFAULT_PAYMENT_CONFIG: PaymentGatewayConfig = {
  bkashAppKey: localStorage.getItem('marketbd_bkash_app_key') || '',
  bkashAppSecret: localStorage.getItem('marketbd_bkash_app_secret') || '',
  nagadMerchantId: localStorage.getItem('marketbd_nagad_merchant_id') || '',
  sslcommerzStoreId: localStorage.getItem('marketbd_ssl_store_id') || '',
  sslcommerzStorePassword: localStorage.getItem('marketbd_ssl_store_pass') || '',
  isLiveMode: localStorage.getItem('marketbd_payment_live_mode') === 'true',
  autoSettle: localStorage.getItem('marketbd_payment_auto_settle') !== 'false'
};
